...
-- Set the chars for split window
vim.opt.fillchars = {
  vert = '│',
  horiz = '─',
  horizup = '┴',
...
-- Color the split windows
vim.api.nvim_set_hl(0, 'VertSplit', { fg = '#5eacd3', bg = 'NONE' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', 'gi', builtin.lsp_implementations, { desc = 'Goto Implementation (Telescope)' })
      ...
      vim.keymap.set('n', '<leader>q', builtin.jumplist, { desc = 'Jumplist (Telescope)' })
